...
type CustomerWithWhatsApp = Customer & {
...
async function getCustomers(): Promise<CustomerWithWhatsApp[]> {
  try {
...
export function CustomerTableEnhanced({ showWhatsappStatus = false, whatsappOnly = false }: CustomerTableProps) {
  const router = useRouter()
  const [customers, setCustomers] = useState<CustomerWithWhatsApp[]>([])
