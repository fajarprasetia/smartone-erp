...
async function testPrintUpdate(): Promise<Order> {
  ...
  try {
    ...
    log('error', `Failed to update print information: ${(error as Error).message}`);
    throw error;
  }
}

// Test marking print as done
async function testPrintDone(): Promise<Order> {
  ...
  try {
    ...
    log('error', `Failed to mark print as done: ${(error as Error).message}`);
    throw error;
  }
}

// Test updating press information
async function testPressUpdate(): Promise<Order> {
  ...
  try {
    ...
    log('error', `Failed to update press information: ${(error as Error).message}`);
    throw error;
  }
}

// Test marking press as done
async function testPressDone(): Promise<Order> {
  ...
  try {
    ...
    log('error', `Failed to mark press as done: ${(error as Error).message}`);
    throw error;
  }
}
